...
// .wrangler/tmp/bundle-R9khcF/checked-fetch.js
...
var updateUserProfile = /* @__PURE__ */ __name(async (c) => {
  try {
    ...
    try {
      ...
      console.log(`\u2705 Perfil actualizado: ${name}${avatar ? `, avatar actualizado` : ""}`);
...
var isAdmin = /* @__PURE__ */ __name(async (c, next) => {
  ...
  if (user.email !== "barhomus@gmail.com") {
...
// .wrangler/tmp/bundle-R9khcF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-R9khcF/middleware-loader.entry.ts
