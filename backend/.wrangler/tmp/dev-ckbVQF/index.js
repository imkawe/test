...
// .wrangler/tmp/bundle-d5ZPsN/checked-fetch.js
...
var login = /* @__PURE__ */ __name(async (c) => {
  try {
    ...
    console.log("\u{1F511} Token generado:", token);
    return c.json({ token });
  } catch (error) {
...
// .wrangler/tmp/bundle-d5ZPsN/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-d5ZPsN/middleware-loader.entry.ts
