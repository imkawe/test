...
// .wrangler/tmp/bundle-l1KAU4/checked-fetch.js
...
var isAdmin = /* @__PURE__ */ __name(async (c, next) => {
  ...
  if (!user || user.email !== "barhomus@gmail.com") {
    return c.json({
...
// .wrangler/tmp/bundle-l1KAU4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-l1KAU4/middleware-loader.entry.ts
